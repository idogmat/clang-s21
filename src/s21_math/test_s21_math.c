...
START_TEST(s21_abs_f)
{
    ...
    for (int i = -1234567; i < 1234567; i += 1)
    {
...
START_TEST(s21_fabs_f) {
    ck_assert_uint_eq(s21_fabs(-654367.54283), fabs(-654367.54283));
    ck_assert_uint_eq(s21_fabs(-65.345), fabs(-65.345));
    ck_assert_uint_eq(s21_fabs(1.00), fabs(1.00));
}
END_TEST
